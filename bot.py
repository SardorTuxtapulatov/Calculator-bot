...
from aiogram.fsm.context import FSMContextc 
from middlewares.throttling import ThrottlingMiddleware #new
from states.reklama import Adverts
from aiogram.types import InlineKeyboardButtoncdcdcdcdc
...
async def callback_answer(callback: CallbackQuery):
    ...
    if callback.message.text == "|":
        ...
        if callback.data == "D":
            ...
            await calculator_button("Endi to'g'ri buyruq kiritng iltimos",show_alert=True)
...
async def xabar(message: Message):
    await message.answer("Botingiz ishlayabdi bironta ma'lumot!")
